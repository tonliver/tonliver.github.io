...
## 正确的使用姿势
我暂停了让AI无休止的打补丁，花了半天时间review了AI写的代码，发现它实现了很多零散的功能，每一个都设计良好、代码规范、接口清晰，但感觉缺少一个系统层面的骨架，把这些零件有效的组织起来。我开始反思，如果从零开始，我会怎么实现这个功能，我决定用**由易到难，逐步迭代**的策略，把AI当成另一个我，用合作的方式去实现这个功能。
...
这7步是7次迭代，我确认每个迭代的功能符合预期后，会告诉AI，当前的算法是正确的，接下来基于目前的算法做进一步优化，再告诉它下个迭代要实现的功能。通过这种方式，程序变成了一个渐进进化的过程，AI也因每一小步任务变的清晰，并能从我这里得到反馈，变的更加有序。

## 反思
AI在实现具体的功能时，非常高效且准确，基本都能在30秒内完成，这就意味着我们可以快速的看到效果，这个效果就是我们得到的反馈，然后我们基于这些反馈产生更多的思考，是已满足需求还是产生新的优化方向，思考的结果再反馈给AI，多次迭代，让AI越来越了解我们的想法，也让我们的想法越来越清晰，这不正是迭代开发的真谛吗？AI的参与可以让迭代的周期缩短到分钟级别，这是我认为目前和AI比较优的一种协作模式。我一直相信**好的产品不是设计出来的，而是迭代出来的。**